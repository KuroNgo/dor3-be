...
// ILessonRepository is an autogenerated mock type for the ILessonRepository type
type ILessonRepository struct {
	mock.Mock
}

// CreateOneByNameCourseInAdmin provides a mock function with given fields: ctx, lesson
func (_m *ILessonRepository) CreateOneByNameCourseInAdmin(ctx context.Context, lesson *lesson_domain.Lesson) error {
...
func (_m *ILessonRepository) CreateOneInAdmin(ctx context.Context, lesson *lesson_domain.Lesson) error {
	ret := _m.Called(ctx, lesson)
...
func (_m *ILessonRepository) DeleteOneInAdmin(ctx context.Context, lessonID string) error {
...
func (_m *ILessonRepository) FetchByIDCourseInUser(ctx context.Context, userID primitive.ObjectID, courseID string, page string) ([]lesson_domain.LessonProcessResponse, lesson_domain.DetailResponse, error) {
...
func (_m *ILessonRepository) FetchByIDInAdmin(ctx context.Context, lessonID string) (lesson_domain.LessonResponse, error) {
	ret := _m.Called(ctx, lessonID)
...
func (_m *ILessonRepository) FetchByIDInUser(ctx context.Context, userID primitive.ObjectID, lessonID string) (lesson_domain.LessonProcessResponse, error) {
...
func (_m *ILessonRepository) FetchByIdCourseInAdmin(ctx context.Context, idCourse string, page string) ([]lesson_domain.LessonResponse, lesson_domain.DetailResponse, error) {
...
func (_m *ILessonRepository) FetchManyInAdmin(ctx context.Context, page string) ([]lesson_domain.LessonResponse, lesson_domain.DetailResponse, error) {
...
func (_m *ILessonRepository) FetchManyInUser(ctx context.Context, userID primitive.ObjectID, page string) ([]lesson_domain.LessonProcessResponse, lesson_domain.DetailResponse, error) {
...
func (_m *ILessonRepository) FetchManyNotPaginationInAdmin(ctx context.Context) ([]lesson_domain.LessonResponse, lesson_domain.DetailResponse, error) {
	ret := _m.Called(ctx)
...
func (_m *ILessonRepository) FetchManyNotPaginationInUser(ctx context.Context, userID primitive.ObjectID) ([]lesson_domain.LessonProcessResponse, lesson_domain.DetailResponse, error) {
...
func (_m *ILessonRepository) FindLessonIDByLessonNameInAdmin(ctx context.Context, lessonName string) (primitive.ObjectID, error) {
...
func (_m *ILessonRepository) Statistics(ctx context.Context, countOptions primitive.M) (lesson_domain.Statistics, error) {
	...
	var r0 lesson_domain.Statistics
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, primitive.M) (lesson_domain.Statistics, error)); ok {
		return rf(ctx, countOptions)
	}
	if rf, ok := ret.Get(0).(func(context.Context, primitive.M) lesson_domain.Statistics); ok {
		r0 = rf(ctx, countOptions)
	} else {
		r0 = ret.Get(0).(lesson_domain.Statistics)
	}
...
func (_m *ILessonRepository) UpdateCompleteInUser(ctx context.Context, user primitive.ObjectID) (*mongo.UpdateResult, error) {
...
func (_m *ILessonRepository) UpdateImageInAdmin(ctx context.Context, lesson *lesson_domain.Lesson) (*mongo.UpdateResult, error) {
	ret := _m.Called(ctx, lesson)
...
func (_m *ILessonRepository) UpdateOneInAdmin(ctx context.Context, lesson *lesson_domain.Lesson) (*mongo.UpdateResult, error) {
	ret := _m.Called(ctx, lesson)
...
// NewILessonRepository creates a new instance of ILessonRepository. It also registers a testing interface on the mock and a cleanup function to assert the test expectations.
// The first argument is typically a *testing.T value.
func NewILessonRepository(t interface {
	mock.TestingT
	Cleanup(func())
}) *ILessonRepository {
	mock := &ILessonRepository{}
	mock.Mock.Test(t)
