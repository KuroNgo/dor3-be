...
func (_m *ICourseUseCase) CreateOne(ctx context.Context, _a1 *lesson.Lesson) error {
...
func (_m *ICourseUseCase) DeleteOne(ctx context.Context, lessonID string) error {
...
func (_m *ICourseUseCase) FetchByID(ctx context.Context, lessonID string) (*lesson.Lesson, error) {
	ret := _m.Called(ctx, lessonID)
...
func (_m *ICourseUseCase) FetchMany(ctx context.Context) ([]lesson.Lesson, error) {
	ret := _m.Called(ctx)
...
func (_m *ICourseUseCase) FetchToDeleteMany(ctx context.Context) (*[]lesson.Lesson, error) {
	ret := _m.Called(ctx)
...
func (_m *ICourseUseCase) UpdateOne(ctx context.Context, lessonID string, _a2 lesson.Lesson) error {
...
func (_m *ICourseUseCase) UpsertOne(ctx context.Context, id string, _a2 *lesson.Lesson) (*lesson.Lesson, error) {
