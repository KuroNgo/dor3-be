...
func (_m *IVocabularyRepository) CreateOneByNameUnitInAdmin(ctx context.Context, vocabulary *vocabulary_domain.Vocabulary) error {
...
func (_m *IVocabularyRepository) CreateOneInAdmin(ctx context.Context, vocabulary *vocabulary_domain.Vocabulary) error {
	ret := _m.Called(ctx, vocabulary)
...
func (_m *IVocabularyRepository) DeleteOneInAdmin(ctx context.Context, vocabularyID string) error {
...
func (_m *IVocabularyRepository) FetchByIdUnitInAdmin(ctx context.Context, idUnit string) ([]vocabulary_domain.Vocabulary, error) {
...
func (_m *IVocabularyRepository) FetchByLessonInBoth(ctx context.Context, unitName string) (vocabulary_domain.SearchingResponse, error) {
...
func (_m *IVocabularyRepository) FetchByWordInBoth(ctx context.Context, word string) (vocabulary_domain.SearchingResponse, error) {
...
func (_m *IVocabularyRepository) FetchManyInBoth(ctx context.Context, page string) (vocabulary_domain.Response, error) {
...
func (_m *IVocabularyRepository) FindVocabularyIDByVocabularyConfigInAdmin(ctx context.Context, word string) (primitive.ObjectID, error) {
	ret := _m.Called(ctx, word)
...
func (_m *IVocabularyRepository) GetAllVocabularyInAdmin(ctx context.Context) ([]string, error) {
	ret := _m.Called(ctx)
...
func (_m *IVocabularyRepository) GetLatestVocabularyInAdmin(ctx context.Context) ([]string, error) {
	ret := _m.Called(ctx)
...
func (_m *IVocabularyRepository) GetVocabularyByIdInAdmin(ctx context.Context, id string) (vocabulary_domain.Vocabulary, error) {
...
func (_m *IVocabularyRepository) UpdateIsFavouriteInUser(ctx context.Context, vocabularyID string, isFavourite int) error {
...
func (_m *IVocabularyRepository) UpdateOneAudioInAdmin(ctx context.Context, vocabulary *vocabulary_domain.Vocabulary) error {
	ret := _m.Called(ctx, vocabulary)
...
func (_m *IVocabularyRepository) UpdateOneImageInAdmin(ctx context.Context, vocabulary *vocabulary_domain.Vocabulary) (*mongo.UpdateResult, error) {
	ret := _m.Called(ctx, vocabulary)
...
func (_m *IVocabularyRepository) UpdateOneInAdmin(ctx context.Context, vocabulary *vocabulary_domain.Vocabulary) (*mongo.UpdateResult, error) {
	ret := _m.Called(ctx, vocabulary)
...
func (_m *IVocabularyRepository) UpdateVocabularyProcess(ctx context.Context, vocabularyID string, process vocabulary_domain.VocabularyProcess) error {
...
// NewIVocabularyRepository creates a new instance of IVocabularyRepository. It also registers a testing interface on the mock and a cleanup function to assert the test expectations.
