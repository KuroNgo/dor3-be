...
func (_m *IUnitRepository) CreateOneByNameLessonInAdmin(ctx context.Context, unit *unit_domain.Unit) error {
...
func (_m *IUnitRepository) CreateOneInAdmin(ctx context.Context, unit *unit_domain.Unit) error {
	ret := _m.Called(ctx, unit)
...
func (_m *IUnitRepository) DeleteOneInAdmin(ctx context.Context, unitID string) error {
...
func (_m *IUnitRepository) FetchByIdLessonInAdmin(ctx context.Context, idLesson string, page string) ([]unit_domain.UnitResponse, unit_domain.DetailResponse, error) {
...
func (_m *IUnitRepository) FetchByIdLessonInUser(ctx context.Context, user primitive.ObjectID, idLesson string, page string) ([]unit_domain.UnitProcessResponse, unit_domain.DetailResponse, error) {
...
func (_m *IUnitRepository) FetchManyInAdmin(ctx context.Context, page string) ([]unit_domain.UnitResponse, unit_domain.DetailResponse, error) {
...
func (_m *IUnitRepository) FetchManyInUser(ctx context.Context, user primitive.ObjectID, page string) ([]unit_domain.UnitProcessResponse, unit_domain.DetailResponse, error) {
...
func (_m *IUnitRepository) FetchManyNotPaginationInAdmin(ctx context.Context) ([]unit_domain.UnitResponse, error) {
	ret := _m.Called(ctx)
...
func (_m *IUnitRepository) FetchManyNotPaginationInUser(ctx context.Context, user primitive.ObjectID) ([]unit_domain.UnitProcessResponse, error) {
...
func (_m *IUnitRepository) FetchOneByIDInAdmin(ctx context.Context, id string) (unit_domain.UnitResponse, error) {
...
func (_m *IUnitRepository) FetchOneByIDInUser(ctx context.Context, user primitive.ObjectID, id string) (unit_domain.UnitProcessResponse, error) {
...
func (_m *IUnitRepository) FindUnitIDByUnitLevelInAdmin(ctx context.Context, unitLevel int, fieldOfIT string) (primitive.ObjectID, error) {
...
func (_m *IUnitRepository) UpdateCompleteInUser(ctx context.Context, user primitive.ObjectID) (*mongo.UpdateResult, error) {
	ret := _m.Called(ctx, user)
...
func (_m *IUnitRepository) UpdateOneInAdmin(ctx context.Context, unit *unit_domain.Unit) (*mongo.UpdateResult, error) {
	ret := _m.Called(ctx, unit)
...
// NewIUnitRepository creates a new instance of IUnitRepository. It also registers a testing interface on the mock and a cleanup function to assert the test expectations.
