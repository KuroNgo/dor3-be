...
func CORSPrivate() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		c.Writer.Header().Set("Access-Control-Allow-Methods", "GET, PUT, POST, PATCH, DELETE, OPTIONS")
		c.Writer.Header().Set("Access-Control-Max-Age", "86400") // 24 giờ
...
func OptionMessagePublic(c *gin.Context) {
	c.Writer.Header().Set("Access-Control-Allow-Origin", "http://localhost:5173")
...
func OptionMessagePrivate(c *gin.Context) {
	c.Writer.Header().Set("Access-Control-Allow-Origin", "http://localhost:3000")
	c.Writer.Header().Set("Access-Control-Allow-Methods", "GET, PUT, PATCH, POST, DELETE, OPTIONS")
	c.Writer.Header().Set("Access-Control-Max-Age", "86400") // 24 giờ
...
func OptionMessageMiddle(c *gin.Context) {
