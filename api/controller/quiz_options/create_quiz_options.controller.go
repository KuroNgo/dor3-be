...
func (q *QuizOptionsController) CreateOneQuizOptions(ctx *gin.Context) {
	...
	options := quiz_options_domain.QuizOptions{
	...
	err = q.QuizOptionsUseCase.CreateOne(ctx, &options)
	if err != nil {
