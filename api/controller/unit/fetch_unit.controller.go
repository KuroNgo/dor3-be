...
func (u *UnitController) FetchMany(ctx *gin.Context) {
	...
	unit, detail, err := u.UnitUseCase.FetchManyInUser(ctx, user.ID, page)
	if err != nil {
...
func (u *UnitController) FetchManyNotPagination(ctx *gin.Context) {
	...
	unit, err := u.UnitUseCase.FetchManyNotPaginationInUser(ctx, user.ID)
	if err != nil {
		ctx.JSON(http.StatusInternalServerError, gin.H{
			"status":  "error",
			"message": err.Error(),
...
func (u *UnitController) FetchByIdLesson(ctx *gin.Context) {
	...
	unit, err := u.UnitUseCase.FetchByIdLessonInUser(ctx, user.ID, idLesson)
	if err != nil {
		ctx.JSON(http.StatusInternalServerError, gin.H{
			"status":  "error",
			"message": err.Error(),
...
func (u *UnitController) FetchById(ctx *gin.Context) {
	currentUser, exists := ctx.Get("currentUser")
	if !exists {
		ctx.JSON(http.StatusUnauthorized, gin.H{
			"status":  "fail",
	...
	unit, err := u.UnitUseCase.FetchOneByIDInUser(ctx, user.ID, idUnit)
	if err != nil {
		ctx.JSON(http.StatusInternalServerError, gin.H{
			"status":  "error",
			"message": err.Error(),
...
func (u *UnitController) FetchManyByAdmin(ctx *gin.Context) {
	currentUser, exists := ctx.Get("currentUser")
	if !exists {
		ctx.JSON(http.StatusUnauthorized, gin.H{
			"status":  "fail",
...
func (u *UnitController) FetchManyNotPaginationByAdmin(ctx *gin.Context) {
	currentUser, exists := ctx.Get("currentUser")
	if !exists {
		ctx.JSON(http.StatusUnauthorized, gin.H{
			"status":  "fail",
...
func (u *UnitController) FetchByIdLessonByAdmin(ctx *gin.Context) {
	currentUser, exists := ctx.Get("currentUser")
	if !exists {
		ctx.JSON(http.StatusUnauthorized, gin.H{
			"status":  "fail",
...
func (u *UnitController) FetchByIdInAdmin(ctx *gin.Context) {
	currentUser, exists := ctx.Get("currentUser")
	if !exists {
		ctx.JSON(http.StatusUnauthorized, gin.H{
			"status":  "fail",
