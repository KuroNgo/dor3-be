...
func (e *ExerciseQuestionsController) UpdateOneExerciseOptions(ctx *gin.Context) {
	...
	questions := exercise_questions_domain.ExerciseQuestion{
	...
	_, err = e.ExerciseQuestionUseCase.UpdateOneInAdmin(ctx, &questions)
	if err != nil {
