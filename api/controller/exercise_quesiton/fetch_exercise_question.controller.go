...
func (e *ExerciseQuestionsController) FetchOneExerciseQuestionByExerciseID(ctx *gin.Context) {
	currentUser, exists := ctx.Get("currentUser")
	if !exists {
		ctx.JSON(http.StatusUnauthorized, gin.H{
			"status":  "fail",
...
func (e *ExerciseQuestionsController) FetchManyExerciseQuestionByExerciseID(ctx *gin.Context) {
	currentUser, exists := ctx.Get("currentUser")
	if !exists {
		ctx.JSON(http.StatusUnauthorized, gin.H{
			"status":  "fail",
...
func (e *ExerciseQuestionsController) FetchOneExerciseQuestionByIDInAdmin(ctx *gin.Context) {
	currentUser, exists := ctx.Get("currentUser")
	if !exists {
		ctx.JSON(http.StatusUnauthorized, gin.H{
			"status":  "fail",
...
func (e *ExerciseQuestionsController) FetchOneExerciseQuestionByExerciseIDInAdmin(ctx *gin.Context) {
	currentUser, exists := ctx.Get("currentUser")
	if !exists {
		ctx.JSON(http.StatusUnauthorized, gin.H{
			"status":  "fail",
...
func (e *ExerciseQuestionsController) FetchManyExerciseQuestionByExerciseIDInAdmin(ctx *gin.Context) {
	currentUser, exists := ctx.Get("currentUser")
	if !exists {
		ctx.JSON(http.StatusUnauthorized, gin.H{
			"status":  "fail",
