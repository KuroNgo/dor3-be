...
// If you want to persist data for the lifetime of the running application (or until
// you deliberately delete the data) you can create a generic Cache type like this
