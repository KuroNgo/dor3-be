...
import (
	mocks "clean-architecture/infrastructor/mongo/test"
	context "context"
...
func (_m *Collection) Aggregate(_a0 context.Context, _a1 interface{}) (mocks.Cursor, error) {
	...
	var r0 mocks.Cursor
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, interface{}) (mocks.Cursor, error)); ok {
		return rf(_a0, _a1)
	}
	if rf, ok := ret.Get(0).(func(context.Context, interface{}) mocks.Cursor); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(mocks.Cursor)
		}
	}
...
func (_m *Collection) Find(_a0 context.Context, _a1 interface{}, _a2 ...*options.FindOptions) (mocks.Cursor, error) {
	_va := make([]interface{}, len(_a2))
	for _i := range _a2 {
		_va[_i] = _a2[_i]
	}
	...
	var r0 mocks.Cursor
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, interface{}, ...*options.FindOptions) (mocks.Cursor, error)); ok {
		return rf(_a0, _a1, _a2...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, interface{}, ...*options.FindOptions) mocks.Cursor); ok {
		r0 = rf(_a0, _a1, _a2...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(mocks.Cursor)
...
func (_m *Collection) FindOne(_a0 context.Context, _a1 interface{}) mocks.SingleResult {
	ret := _m.Called(_a0, _a1)
	...
	var r0 mocks.SingleResult
	if rf, ok := ret.Get(0).(func(context.Context, interface{}) mocks.SingleResult); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(mocks.SingleResult)
		}
	}
...
// NewCollection creates a new instance of Collection. It also registers a testing interface on the mock and a cleanup function to assert the test expectations.
