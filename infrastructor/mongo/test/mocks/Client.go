...
func (_m *Client) Database(_a0 string) mocks.Database {
	ret := _m.Called(_a0)
	...
	var r0 mocks.Database
	if rf, ok := ret.Get(0).(func(string) mocks.Database); ok {
		r0 = rf(_a0)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(mocks.Database)
		}
	}
...
// NewClient creates a new instance of Client. It also registers a testing interface on the mock and a cleanup function to assert the test expectations.
