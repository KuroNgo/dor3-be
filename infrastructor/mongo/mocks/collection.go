...
import (
	mongo "clean-architecture/infrastructor/mongo"
	context "context"
...
func (_m *Collection) DeleteMany(ctx context.Context, filter interface{}, opts ...*options.DeleteOptions) (*mongo_drivermongo.DeleteResult, error) {
